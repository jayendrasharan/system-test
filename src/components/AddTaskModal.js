...
let TodoTask = props => {
  ...
  return (
    <form onSubmit={props => handleSubmit(props)} className="form">
      <div className="field">
      ...
      <div
        className="field"
        style={{ marginLeft: "15px", left: "0px", position: "relative" }}
      >
        <div className="control">
          <Field
            className="date"
      ...
      <div className="field" style={{ marginLeft: "15px", float: "right" }}>
        <div className="control">
          <button className="submitbtn" type="submit" onClick={submitForm}>
            Save
          </button>
        </div>
      </div>
...
class DropDownSelect extends React.Component {
  ...
  render() {
    ...
    return (
      <select {...input}>
        <option key="None" value="None" default>
          None
        </option>
