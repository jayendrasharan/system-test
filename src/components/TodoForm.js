    ...
    <form style={{ margin: "15px" }} noValidate>
      ...
      <div className="form-group-1">
        ...
        <div className="form-control-1">
          ...
          <span style={{color:'red'}}>{errors && errors.description ? (errors.description.required ? 'Description is required' :(errors.description.minLength || errors.description.maxLength ? 'Description should be between 10 to 140 characters' : null)) : null}</span>
        </div>
      </div>
