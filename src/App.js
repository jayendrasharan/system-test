...
var ToDoBanner = React.createContext({
render: function(){
  return ( 
   <h3>TODO....react.js</h3>
  );
...
var ToDoList = React.createContext({
Remove: function(e){
...
var ToDoListItem = React.createContext({
...
var ToDoForm = React.createContext({
...
var ToDoFilter = React.createContext({
...
var ToDoCatalogForm = React.createContext({
getInitialState: function() {
  return {item: ''};
    },
handleSubmit: function(e){
...
var ToDoCatelog  = React.createContext({
...
var TodoApp = React.createContext({
getInitialState : function(){
