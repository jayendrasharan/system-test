...
1. Download the code or pull the repository in your local directory.
2. Run \$npm install
3. Run \$npm start
4. Also here is the live version of the code -

Following all the instructions for this project.
