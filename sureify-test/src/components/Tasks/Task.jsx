...
const Task = (props) => {
    ...
    return (
        <>
            <div className="form-header">
                {
                    props.mode === EntryWindowMode.Add ? "Add Task" :
                        (props.mode === EntryWindowMode.Edit ? "Edit Task" : props.mode === EntryWindowMode.Delete ? 'Delete Task' : "View Task Details")
                }
            </div>
            {(props.mode === EntryWindowMode.Add || props.mode === EntryWindowMode.Edit || props.mode === EntryWindowMode.View) &&
            ...
            {
                props.mode === EntryWindowMode.Delete &&
                <>
                    <Form.Group as={Col} md="12" className="m-b-0">
                        <Form.Row><Form.Label>Are you sure you want to delete this task</Form.Label> </Form.Row>
                    </Form.Group>
                    <Form.Row>
                        <Form.Group as={Col} md="12" className="m-b-0">
                            <div className="modal-button-section">
                                ...
                                <Button variant="primary" className="btn-save" onClick={() => props.onConfirmDelete()}>
                                    Yes
                                 </Button>
                            </div>
                        </Form.Group>
